...
const gamesData = {
  ...
  crossword_grade8_lesson2: {
    ...
    gridSize: 10,
    words: [
      { word: "ПРОЕКТ", x: 0, y: 0, direction: "across", clue: "Самостоятельная исследовательская работа" },
      { word: "ТЕМА", x: 0, y: 2, direction: "down", clue: "То, что выбирается в первую очередь" },
      { word: "АНАЛИЗ", x: 4, y: 0, direction: "down", clue: "Детальное изучение музыкального произведения" },
      { word: "ВЫВОД", x: 0, y: 5, direction: "across", clue: "Итог исследования, помещаемый в конце" },
      { word: "ИСТОЧНИК", x: 6, y: 3, direction: "down", clue: "Книга, статья или запись, откуда взята информация" }
    ]
  },
  wordsearch_grade8_lesson2: {
    title: "Структура проекта",
    gridSize: 12,
    words: ["ПРОЕКТ", "ИССЛЕДОВАНИЕ", "ТЕМА", "ПЛАН", "АНАЛИЗ", "ВЫВОД", "ИСТОЧНИК", "ЦЕЛЬ"],
    grid: []
  },
  emoji_grade8_lesson2: {
    puzzles: [
      { emoji: "🔍🎵📝", answer: "Исследование", hint: "Процесс изучения музыкального явления" },
      { emoji: "🎸🎤📜", answer: "Авторская песня", hint: "Жанр, связанный с именем Булата Окуджавы" },
      { emoji: "🕌🌙", answer: "Восточная тема", hint: "Направление в творчестве Римского-Корсакова и Бородина" },
      { emoji: "🏛️🕊️", answer: "Духовная музыка", hint: "Музыка в храмовом синтезе искусств" },
      { emoji: "🔄🎧", answer: "Современная обработка", hint: "Когда классику играют на электрогитарах или синтезаторах" }
    ]
  },
  rebus_grade8_lesson2: {
    puzzles: [
      ...
      { answer: "ОТЧЕТ", clue: "Документ, содержащий результаты работы" }
    ]
  }
};
